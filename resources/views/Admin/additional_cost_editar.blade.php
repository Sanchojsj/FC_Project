                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" name="additional_cost_name" type="text" placeholder="" value="{{ $additional_costs->additional_cost_name }}" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="small mb-1" for="price">Precio</label>
                                    <input class="form-control py-4" name="price" type="text" placeholder="" value="{{ $additional_costs->price}}" />
                                </div>
                            </div>
                        <Textarea name="body" cols="20" rows="4" class="form-control m-2" placeholder="body">{{ $additional_costs->body }}</Textarea>
