        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Añadir Nueva Factura</h3></div>
                    <div class="card-body">
                        ...
                        <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="small mb-1" for="inputState">Categoria del Producto</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <select id="inputState" name="name" class="form-control">
                                        <option selected>Seleccionar Nombre del Producto...</option>
                                        @foreach($products as $row)
                                            @if( $row->stock > 1)
